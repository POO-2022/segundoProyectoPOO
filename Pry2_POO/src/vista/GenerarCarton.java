 ...
 * @author User
 */
public class GenerarCarton extends javax.swing.JFrame {

    /**
     * Creates new form GenerarCarton
     */
    ...
    private void initComponents() {
        ...
        btGenerarCartones.setBackground(new java.awt.Color(0, 51, 0));
        btGenerarCartones.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GenerarCarton.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GenerarCarton().setVisible(true);
            }
        });
    }
